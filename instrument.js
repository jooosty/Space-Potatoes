...
const diagComponents = {
  ...
  oba: {
    1: { name: 'X-ray Concentrators (×10 science)', desc: '10 Wolter type 1 concentrators in a 3-2-3-2 hexagonal layout. Each 10 cm diameter, 30 nested gold-coated mirrors on Al substrate. Gold coating maximises X-ray reflectivity at the required grazing-incidence angles. Effective area: 200 cm² at 1 keV, 180 cm² at 6 keV.' },
    2: { name: 'OBA Plate (Al 6061-T6)',             desc: '30 mm thick Al 6061-T6 plate machined to create concentrator cutouts in a hexagonal pattern. High specific stiffness maintains alignment under gravity during ground handling and under thermal gradients in orbit. Concentrators screwed in using M3 screws at 3 connection points each, with spider-web support structures holding mirror shells.' },
    3: { name: 'Titanium Bipod Isostatic Mounts',    desc: 'Three Ti-6Al-4V bipod mounts form a quasi-kinematic (slightly over-constrained) isostatic interface. Each bipod consists of two 12 mm diameter titanium rods meeting at the instrument interface. Mounting plane coincides with instrument CoG for minimal thermal-induced stress transfer. Bolted to a 22 mm composite honeycomb S/C panel.' },
    4: { name: 'Calibration Concentrators (×2)',     desc: 'Two calibration Focal Plane Modules (FPCMs) in the second row. Each contains an iron-55 X-ray source placed 9 cm above the detector. The source is in a holder with an opening only facing the detector, enclosed in a 1 mm thick aluminium tube. Irradiating with a known spectrum allows in-flight calibration of the detector energy response.' },
  },
  rw: {
